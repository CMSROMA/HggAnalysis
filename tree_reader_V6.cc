...
void tree_reader_V6::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pid_hlwTrackBestRank", pid_hlwTrackBestRank, &b_pid_hlwTrackBestRank);
   fChain->SetBranchAddress("pid_hlwTrackWorstVtx", pid_hlwTrackWorstVtx, &b_pid_hlwTrackWorstVtx);
   ...
   fChain->SetBranchAddress("pid_hlwTrack03BestRank", pid_hlwTrack03BestRank, &b_pid_hlwTrack03BestRank);
   fChain->SetBranchAddress("pid_hlwTrack03WorstVtx", pid_hlwTrack03WorstVtx, &b_pid_hlwTrack03WorstVtx);
   ...
   fChain->SetBranchAddress("vptbal", vptbal, &b_vptbal);
   fChain->SetBranchAddress("vptasym", vptasym, &b_vptasym);
   fChain->SetBranchAddress("vlogsumpt2", vlogsumpt2, &b_vlogsumpt2);
   fChain->SetBranchAddress("vrank", vrank, &b_vrank);
