#define tree_reader_V7_cxx
#include "tree_reader_V7.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void tree_reader_V7::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L tree_reader_V7.C
//      Root > tree_reader_V7 t
...
#ifdef tree_reader_V7_cxx
tree_reader_V7::tree_reader_V7(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("dcap:///pnfs/roma1.infn.it/data/cms/store/user/rahatlou/MC/41xV7/QCD_Pt-30to40_doubleEMEnriched_TuneZ2_7TeV-pythia6-41x_ntpv1/output_89_1_z0g.root");
      if (!f) {
         f = new TFile("dcap:///pnfs/roma1.infn.it/data/cms/store/user/rahatlou/MC/41xV7/QCD_Pt-30to40_doubleEMEnriched_TuneZ2_7TeV-pythia6-41x_ntpv1/output_89_1_z0g.root");
         f->cd("dcap:///pnfs/roma1.infn.it/data/cms/store/user/rahatlou/MC/41xV7/QCD_Pt-30to40_doubleEMEnriched_TuneZ2_7TeV-pythia6-41x_ntpv1/output_89_1_z0g.root:/myanalysis");
      }
...
tree_reader_V7::~tree_reader_V7()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tree_reader_V7::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tree_reader_V7::LoadTree(Long64_t entry)
{
...
void tree_reader_V7::Init(TTree *tree)
{
...
void tree_reader_V7::Show(Long64_t entry)
{
...
Int_t tree_reader_V7::Cut(Long64_t entry)
{
...
#endif // #ifdef tree_reader_V7_cxx
