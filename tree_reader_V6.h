...
public :
   ...
   Float_t         pu_sumpt_highpt[50];   //[pu_n]
   Float_t         pu_ntrks_lowpt[50];   //[pu_n]
   Float_t         pu_ntrks_highpt[50];   //[pu_n]
   Int_t           nPhot;
   ...
   Float_t         ptDJet_pfakt5[100];   //[nJet_pfakt5]
   Float_t         rmsCandJet_pfakt5[100];   //[nJet_pfakt5]
   Float_t         combinedSecondaryVertexBJetTags[100];   //[nJet_pfakt5]
   Float_t         combinedSecondaryVertexMVABJetTags[100];   //[nJet_pfakt5]
   Float_t         jetBProbabilityBJetTags[100];   //[nJet_pfakt5]
   Float_t         jetProbabilityBJetTags[100];   //[nJet_pfakt5]
   Float_t         simpleSecondaryVertexHighEffBJetTags[100];   //[nJet_pfakt5]
   Float_t         simpleSecondaryVertexHighPurBJetTags[100];   //[nJet_pfakt5]
   Float_t         softMuonBJetTags[100];   //[nJet_pfakt5]
   Float_t         softMuonByIP3dBJetTags[100];   //[nJet_pfakt5]
   Float_t         softMuonByPtBJetTags[100];   //[nJet_pfakt5]
   Float_t         softElectronByIP3dBJetTags[100];   //[nJet_pfakt5]
   Float_t         softElectronByPtBJetTags[100];   //[nJet_pfakt5]
   Float_t         trackCountingHighPurBJetTags[100];   //[nJet_pfakt5]
   Float_t         trackCountingHighEffBJetTags[100];   //[nJet_pfakt5]
