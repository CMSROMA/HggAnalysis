...
set bkgsamples = ( DiPhotonBox_Pt25to250_TrackingParticles_7TeV-pythia6_bis DiPhotonJets_7TeV-madgraph GJet_Pt-20_doubleEMEnriched_TuneZ2 )
...
set samples = ( $higgssamples  $bkgsamples $qcdsamples $datasamples)
#set samples = ( $datasamples )


set outdir = redntp.pt1stgam50.looseid.V2
